                      ...
                      shadCNComponent={(field) => {
                        return (
                          <>
                            ...
                            >
                               เงื่อนไขการใช้บริการและนโยบายความเป็นส่วนตัว <span className="text-red-500">*</span>
                            </span>
                          </>
                        )
                      }}
    ...
    >
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid grid-cols-2 mb-4">
          <TabsTrigger value="terms" className="text-teal-700">
            เงื่อนไขการใช้บริการ
          </TabsTrigger>
          <TabsTrigger value="privacy" className="text-teal-700">
        ...
        <div className="overflow-y-auto max-h-[60vh] p-4 bg-teal-50 rounded-lg">
            <p className="space-y-4 text-gray-700">
              <span className="font-bold text-teal-700">
                นโยบายความเป็นส่วนตัว (Privacy Policy) และความยินยอมในการใช้ข้อมูลส่วนบุคคล (PDPA Consent)
              </span>
              <br />
              อัปเดตล่าสุด: 11 May 2025
              <br />
              เว็บไซต์ https://jobtutordream.com/ ให้ความสำคัญกับการคุ้มครองข้อมูลส่วนบุคคลของผู้ใช้งานทุกท่าน รวมถึง ผู้ปกครอง, นักเรียน,
              และ ติวเตอร์ โดยการเก็บ ใช้ และเปิดเผยข้อมูลส่วนบุคคล จะเป็นไปตามข้อกำหนดของ พระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562
              (PDPA)
              <br />
              <br />
              <b className="text-teal-700">1. ข้อมูลส่วนบุคคลที่เก็บรวบรวม</b>
              <br />
              เราอาจเก็บรวบรวมข้อมูล เช่น:
              <br />
              ชื่อ-นามสกุล, เบอร์โทรศัพท์, อีเมล, ที่อยู่, ไลน์ไอดี, วันเกิด
              <br />
              สำเนาบัตรประชาชน (เพื่อยืนยันตัวตนติวเตอร์)
              <br />
              ประวัติการศึกษา และหลักฐานการศึกษาของติวเตอร์
              <br />
              ความถนัดในการสอน รางวัล ผลงาน ประสบการณ์
              <br />
              ไฟล์คะแนนสอบ
              <br />
              ...
              <br />
              <br />
              <b className="text-teal-700">2. วัตถุประสงค์ของการใช้ข้อมูล</b>
              <br />
              เพื่อจัดหานักเรียนให้ติวเตอร์
              <br />
              ...
              <br />
              <br />
              <b className="text-teal-700">3. การเปิดเผยข้อมูลส่วนบุคคล</b>
              <br />
              ...
              <br />
              <br />
              <b className="text-teal-700">4. ความยินยอมจากผู้ปกครอง (กรณีผู้เยาว์)</b>
              <br />
              หากผู้ใช้งานมีอายุต่ำกว่า 20 ปีบริบูรณ์:
              <br />
              จำเป็นต้องได้รับความยินยอมจาก ผู้ปกครองตามกฎหมาย
              <br />
              การลงทะเบียนหรือใช้บริการ ถือว่าผู้ปกครองรับทราบและยินยอมให้เก็บ ใช้ และเปิดเผยข้อมูล
              <br />
              <br />
              <b className="text-teal-700">5. ระยะเวลาในการเก็บรักษาข้อมูล</b>
              <br />
              เราจะเก็บรักษาข้อมูลส่วนบุคคลของท่านไว้ ตราบเท่าที่จำเป็นต่อวัตถุประสงค์ที่ได้แจ้งไว้ หรือ ตามระยะเวลาที่กฎหมายกำหนด เช่น:
              <br />
              เอกสารธุรกรรมทางบัญชีและภาษี อาจถูกเก็บไว้นานสูงสุด 10 ปี ตามประมวลรัษฎากร
              <br />
              เมื่อพ้นระยะเวลาจำเป็น เราจะลบหรือทำลายข้อมูลของท่านอย่างปลอดภัย
              <br />
              <br />
              <b className="text-teal-700">6. สิทธิของเจ้าของข้อมูลส่วนบุคคล</b>
              <br />
              ท่านมีสิทธิ:
              <br />
              ...
              <br />
              <br />
              <b className="text-teal-700">7. ช่องทางติดต่อ</b>
              <br />
              https://jobtutordream.com/
              <br />
              อีเมล: jobtutordream@gmail.com
              <br />
              โทร: 086-896-5858
              <br />
              ...
              <br />
              <br />
              โดยการสมัครและส่งแบบฟอร์มนี้ ถือว่าท่านได้อ่าน เข้าใจ และยินยอมให้เว็บไซต์เก็บ ใช้ และเปิดเผยข้อมูลส่วนบุคคลตามที่ระบุไว้ข้างต้นแล้ว
            </p>
          </div>
        </TabsContent>
      </Tabs>
